...
*Принцип работы:*
1️⃣ Чтобы запустить бота команда /start
2️⃣ Бот всегда открывает на максимальное количество контрактов
3️⃣ Плечо - 20x
4️⃣ Бот всегда открывает все активные аккаунты
5️⃣ Есть возможность открывать маркетом, BBO, лимитной лесенкой с разницей в 0,01%
6️⃣ Закрываются позиции маркетом и BBO

*Как начать?*
1. Нужно зарегистрировать аккаунты
2. Вводить команду вручную для открытия ордеров или добавить интересующие монеты в кнопку «Fast» и открывать позиции по маркету одной кнопкой
3. Закрываются позиции только командами или вручную

ℹ️ *Возможности:*
• Аккаунты можно добавлять и удалять
• Монеты в «Fast» можно добавлять и удалять
• Лимитные ордера на открытие шорта лесенкою открываются только на монетах с двумя нулями и меньше
• Пример: 0.003 (3 нуля) будет открывать лимитный ордер с одинаковой ценой на всех аккаунтах
• ⚠️ MEXC имеет высокую нагрузку на серверы - могут быть задержки
...
/close SYMBOL - Закрыть по маркету
/closebs SYMBOL - Закрыть SHORT по BBO
...
/fast add SYMBOL - Добавить в Fast
/co SYMBOL - Отменить лимитные ордера`;
